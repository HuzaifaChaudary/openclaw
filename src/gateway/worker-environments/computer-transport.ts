...
export type PreparedWorkerComputer = {
  ...
  bind(operationalRunInstance: OperationalRunInstanceRef): ComputerToolTransport;
      ...
      bind(operationalRunInstance) {
        ...
        return {
          ...
          async invoke(request) {
            ...
            const operation = execute(input, request);
...
export function createWorkerComputerService(
  ...
  const transports = new Map<string, ComputerToolTransport>();
      ...
      const prepared = create(claim).then((computer) => {
        ...
        return {
          ...
          bind(run: OperationalRunInstanceRef) {
            ...
            const bound: ComputerToolTransport = {
