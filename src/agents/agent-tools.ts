...
function createOpenClawCodingToolsInternal(options?: OpenClawCodingToolsOptions): AnyAgentTool[] {
  ...
  const placementComputer = resolveSessionPlacementComputer(options?.operationalRunInstance);
  const sandboxToolPolicy = placementComputer?.sandboxToolPolicy ?? sandbox?.tools;
    ...
    ...(includeOpenClawTools
      ? mergeAgentRingZeroTools(
          ...
          createOpenClawTools({
            ...
            computerTransport: placementComputer === null ? null : placementComputer?.transport,
